    ...
    <>
      ...
      <div className='fixed top-0 left-0 w-full bg-white shadow-md z-50 flex justify-between items-center py-4 px-4 font-medium'>
        ...
        <ul className='hidden sm:flex gap-5 text-sm text-gray-500'>
          <NavLink to='/' className='flex flex-col items-center'>Home</NavLink>
          <NavLink to='/collection' className='flex flex-col items-center'>Collection</NavLink>
          <NavLink to='/about' className='flex flex-col items-center'>About</NavLink>
          <NavLink to='/contact' className='flex flex-col items-center'>Contact</NavLink>
        </ul>
        ...
        <div className='flex flex-col text-gray-600'>
          <div className='flex items-center justify-between p-3 cursor-pointer relative'>
            <div className='flex items-center gap-3'>
              <img onClick={() => setVisible(false)} src={assets.dropdown_icon} className='h-4 rotate-180' alt="Back" />
              <p>Back</p>
            </div>
